...
public class Warehouse extends javax.swing.JFrame {
    ...
    public Warehouse() {
        initComponents();
        table();
        searchField.setBackground(new Color(153,153,153));
    }
     public void search(){
    ...
    private void initComponents() {
        ...
        searchField.setText("Cari berdasarkan nama barang");
    ...
    private void btnEnterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEnterMouseClicked
        ...
        try {
            String sql = "Insert into barang(kd_barang,nama_barang,stock,harga_satuan)"
                    + " values ('"
                    +kodeItem+ "','"
                    +namaItem+"',"
                    +stockItem+","
    ...
    private void btnEditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditMouseClicked
        ...
        try {
            String sql = "Update barang set nama_barang = '"
                    +namaItem+"',stock='"
                    +stockItem+"',harga_satuan='"+hargaItem+"'" +
    ...
    private void searchFieldFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_searchFieldFocusGained
        ...
        if (searchField.getText().equals("Cari berdasarkan nama barang"))
        {
            searchField.setText("");
